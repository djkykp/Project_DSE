...
#ifndef _WEATHER_IAR_SPECIFICATIONS_H_
#define _WEATHER_IAR_SPECIFICATIONS_H_
...
#define ID_TARGET_TEMP 1
#define IDB_TEMP_UP 2
#define IDB_TEMP_DOWN 3
#define IDB_FORECAST_SATURDAY 4
#define IDB_FORECAST_SUNDAY 5
#define IDB_FORECAST_MONDAY 6
#define ID_CURRENT_DAY 7
#define ID_CURRENT_DATE 8
#define ID_CURRENT_TIME 9
#define ID_FORECAST_DAY 10
#define ID_FORECAST_TEMP 11
#define ID_DEMO_VERSION 12
...
UINT ForecastAnimationEvent(GX_WINDOW *widget, GX_EVENT *event_ptr);
VOID ForecastAnimationDraw(GX_WINDOW *widget);
