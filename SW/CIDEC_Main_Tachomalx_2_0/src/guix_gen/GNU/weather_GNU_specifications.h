...
#ifndef _WEATHER_GNU_SPECIFICATIONS_H_
#define _WEATHER_GNU_SPECIFICATIONS_H_
...
#define ID_WINDOW2 1
#define ID_TARGET_TEMP 2
#define IDB_TEMP_UP 3
#define IDB_TEMP_DOWN 4
#define IDB_FORECAST_SATURDAY 5
#define IDB_FORECAST_SUNDAY 6
#define IDB_FORECAST_MONDAY 7
#define ID_CURRENT_DAY 8
#define ID_CURRENT_DATE 9
#define ID_CURRENT_TIME 10
#define ID_FORECAST_DAY 11
#define ID_FORECAST_TEMP 12
#define ID_DEMO_VERSION 13
...
typedef struct WINDOW2_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window2_team_members;
    GX_PROMPT window2_Rafael_iglesias;
    GX_PROMPT window2_team_name;
    GX_PROMPT window2_Alberto;
    GX_PROMPT window2_chuy;
    GX_PROMPT window2_yayo;
} WINDOW2_CONTROL_BLOCK;

typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_WINDOW main_screen_thermostat_panel;
    GX_WINDOW main_screen_thermostat_box;
    GX_PROMPT main_screen_thermostat_text;
    GX_ICON main_screen_target_degree;
    GX_PROMPT main_screen_target_temp;
    GX_PROMPT main_screen_rpm;
    GX_PIXELMAP_BUTTON main_screen_temp_up;
    GX_PIXELMAP_BUTTON main_screen_temp_down;
    GX_PIXELMAP_BUTTON main_screen_forecast_saturday;
    GX_PROMPT main_screen_saturday_text;
    GX_PROMPT main_screen_saturday_range;
    GX_ICON main_screen_saturday_icon;
    GX_PIXELMAP_BUTTON main_screen_forecast_sunday;
    GX_PROMPT main_screen_sunday_text;
    GX_PROMPT main_screen_sunday_range;
    GX_ICON main_screen_sunday_icon;
    GX_PIXELMAP_BUTTON main_screen_forecast_monday;
    GX_PROMPT main_screen_monday_text;
    GX_PROMPT main_screen_monday_range;
    GX_ICON main_screen_monday_icon_1;
    GX_WINDOW main_screen_animation_window;
    GX_PROMPT main_screen_current_day;
    GX_PROMPT main_screen_currennt_date;
    GX_PROMPT main_screen_current_time;
    GX_PROMPT main_screen_forecast_day;
    GX_PROMPT main_screen_forecast_summary;
    GX_PROMPT main_screen_humidity;
    GX_ICON main_screen_forecast_degree;
    GX_PROMPT main_screen_forecast_temp;
    GX_PROMPT main_screen_dutycycle;
} MAIN_SCREEN_CONTROL_BLOCK;

typedef struct SPLASH_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_PROMPT splash_screen_demo_version;
...
VOID TempRangeDraw(GX_PROMPT *widget);
