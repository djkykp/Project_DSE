...
#endif
#if (false)
uint8_t g_display0_fb_foreground[2][((256 * 320) * DISPLAY_BITS_PER_PIXEL_INPUT1) >> 3] BSP_ALIGN_VARIABLE_V2(64) BSP_PLACE_IN_SECTION_V2(".bss");
#else
...
#if (81920)
uint8_t g_sf_el_gx0_jpegbuffer[81920] BSP_ALIGN_VARIABLE_V2(64) BSP_PLACE_IN_SECTION_V2(".bss");
#endif
#endif
...
void sf_message_init0(void) {
	...
	if (SSP_SUCCESS != ssp_err_g_sf_message) {
		...
		g_sf_message_err_callback((void *) &g_sf_message,
				&ssp_err_g_sf_message);
	}
}
/* Instance structure to use this module. */
